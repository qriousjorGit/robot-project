...
if not os.path.isfile('sqlite:///rb3.db'):
    db.create_all()
...
new_bot = Robot(robot_id="tester sarch", robot_name="bot 3 no dups", robot_deactivated="1423663634534512", robot_photo=" photo", robot_title="some title", robot_link='evan fournier')
