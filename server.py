...
june2023 = [x for x in all_2023 if x.robot_deactivated.startswith('06')]
...
@app.route('/2023')
def show_all_2023():
    return render_template('all2023.html', full_list=all_2023, jan_list=jan2023, feb_list=feb2023, march_list=march2023, april_list=april2023, may_list=may2023, june_list=june2023)
